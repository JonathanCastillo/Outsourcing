...
<div class="Container">
  ...
  <div class="row" id="Secciones">
    ...
    <div class="col s12">
      <div>
    <h1 class="grey-text text-darken-2">Ofertas de trabajo.</h1>
      </div>
    </div>
    </center>
    <?php
    ...
    $jobs_model = new jobs();?>
    <?php foreach($jobs_model->ListarPlazas() as $r): ?>
    <div class="col s12 m6">
      <div class="card">
      
        <div class="card-image">
          <img src="<?php echo SERVERURL;?>assets/img/Finanzas.jpg" class="Operaciones">
          <span class="card-title panel blue darken-3"><?php echo $r->Puesto; ?></b></span>
        </div>
...
<!--
      ...
      <div id="resultado" name="resultado"></div>
          ...
          <form action="<?php echo SERVERURL;?>manager/employe/jobsaplications.php" method="POST">
          <input type="hidden" id="Id_Oferta" name="Id_Oferta" value="<?php echo $r->Id_Oferta; ?>">
          <input type="submit" name="Aceptar" value="Aplicar a plaza" class="btn waves-effect waves-light red darken-2">
          </form>
        </div>
        <div class="panel blue accent-3">
