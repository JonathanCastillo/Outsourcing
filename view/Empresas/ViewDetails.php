...
<div class="Container">
  ...
  <div class="row" id="Secciones">
    ...
    <?php foreach($jobs_model->PlazaDetails() as $r): ?>
    ...
    <?php endforeach; ?> 
     ...
     <?php foreach($jobs_model->DetallesDeAplicaciones() as $w): 
        
     ?>
    <li class="collection-item avatar">
      <img class="material-icons circle" src="<?php echo SERVERURL.$w->FotoRuta?>"/>
      ...
      <form method="POST" action="<?php echo SERVERURL;?>view/Empresas/ProfileAPI.php">
      <input type="hidden" name="Id_Usuario" value="<?php echo $w->Id_Usuario;?>">
      <input type="submit" name="Aceptar" value="VER PERFIL" class="btn waves-effect waves-light green darken-2" href="">
      </form>
    </li>
    <?php endforeach; ?> 
  </ul>
