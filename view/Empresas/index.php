...
<div class="Container">
  ...
  <div class="row" id="Secciones">
    ...
    <?php foreach($jobs_model->MisPlazas() as $r): ?>
    <?php 
    $Id=$r->Id_Oferta;
    ...
    <li class="collection-item avatar">
      ...
      foreach($jobs_model->Aplicaciones($Id_Oferta) as $p): 
...
<!--
      ...
      <div class="row">
          <div class="col s4">
          <form action="<?php echo SERVERURL;?>view/Empresas/ViewDetails.php" method="POST">
          ...
          <div class="col s4">
          <form action="<?php echo SERVERURL;?>manager/enterprise/shutdownjob.php" method="POST">
          <input type="hidden" id="Id_Oferta" name="Id_Oferta" value="<?php echo $r->Id_Oferta; ?>">
