	...
	class PlazasController {
        ...
        public function POferta()
        {
            ...
            if (isset($_REQUEST['Puesto'])) { 
                echo "LLegando2";                
                $Modelo=$this->model->PublicarPlaza($Puesto,$Salario,$Requisitos); 
        ...
        {
            session_start();
            require_once 'view/Empresas/PublicarOferta.php';
        }
        ...
        public function ExpressJob()
        {
            require_once 'view/Jobs/Categorias.php';
        }
        ...
        public function SearchProf()
        {
            ...
            #echo $Profesion;
            if (isset($_REQUEST['Aceptar'])) { 
                $Modelo=$this->model->ExpressCategoria($Profesion); 
                require_once 'view/Jobs/ExpressCategoria.php';
            }    
        }
