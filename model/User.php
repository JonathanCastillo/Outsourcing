...
class User
{
	...
	public function __CONSTRUCT()
	{
		...
		public function RegistrarUser($Nombres,$Apellidos,$Telefono,$Email,$Password,$FechaNacimiento,$Domicilio)
		{
			try
			{
				$result = array();
				$stm = $this->pdo->prepare("INSERT INTO usuarios (Nombres, Apellidos,Telefono, Email, Password, Fecha_Nacimiento,Domicilio) values ('$Nombres','$Apellidos','$Telefono','$Email','$Password','$FechaNacimiento','$Domicilio')");
				$stm->execute();
