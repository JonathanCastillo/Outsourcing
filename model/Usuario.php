...
class Usuario
{
	...
	public function CalcularFuturoAnualidadVencida()
	{	
		...
		$Paso3=($Paso2-1);
		$Paso4=$Paso3/$Interes;
		$Resultado1=$Paso4*$Anualidad;
		$Categoria="Anualidad Vencida - F";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
	...
	public function CalcularPresenteAnualidadVencida()
	{	
	...
	public function CalcularPresenteAnualidadAnticipada()
	{	
		...
		$Paso3=1-$Paso2;
		$Paso4=$Paso3/$Interes;
		$Paso5=$Paso4*(1+$Interes);
		$Resultado1=$Paso5*$Anualidad;
		$Categoria="Anualidad Anticipada - P";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function CalcularFuturoAnualidadAnticipada()
	{	
		...
		$Paso5=$Paso4*(1+$Interes);
		$Resultado1=$Paso5*$Anualidad;
		$Categoria="Anualidad Anticipada - F";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function CalcularValorAnualidadAnticipada()
	{	
		
		try
		{
		session_start();
		$Presente=$_POST['Anualidad'];
		$n=$_POST['n'];
		$exponente=$n;
		$Interes=$_POST['Interes'];
		$Proceso=$_POST['Proceso'];
		...
		$Paso4=$Paso3/$Interes;
		$Paso5=$Paso4*(1+$Interes);
		$Resultado1=$Presente/$Paso5;
		$Categoria="Anualidad Anticipada - A";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function CalcularHildaInteresCompuesto()
	{	
		
		try
		{
		session_start();
		$Presente=$_POST['Principal'];
		$n=$_POST['n'];
		$exponente=$n;
		$Interes=$_POST['Interes'];
		$Proceso=$_POST['Proceso'];
		$Paso1=(1+$Interes);
		$Paso2=pow($Paso1,$n);
		$Paso3=$Presente*$Paso2;
		$Resultado1=$Paso3-$Presente;
		$Categoria="Interes Compuesto - I";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function CalcularPresenteInteresCompuesto()
	{	
		...
		$Proceso=$_POST['Proceso'];
		$Step1=(1+$Interes);
		$Step2=pow ($Step1 ,-$exponente);
		$Resultado1=$Futuro*$Step2;
		$Categoria="Interes Compuesto - P";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function CalcularPresenteInteresSimple()
	{	
	...
	public function CalcularFuturoInteresSimple()
	{	
		...
		$Step1=$Interes*$n;
		$Step2=1+$Step1;
		$Resultado1=($Principal*$Step2);
		$Categoria="Interes Simple - F";
		$Usuario=$_SESSION['user'];
		$sql="INSERT INTO Calculos (Categoria,Resultado,Usuario,Procedimiento) VALUES ('$Categoria','$Resultado1','$Usuario','$Proceso')";
		$this->pdo->prepare($sql)->execute();	
		}
	...
	public function ListarTransaccion()
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM categorias order by Nombre DESC");
			$stm->execute();
	...
	public function ListarResultados1()
	{
		try
		{
			$result = array();

			$stm = $this->pdo->prepare("SELECT * FROM Calculos order by Id_Calculo desc limit 1");
			$stm->execute();
	...
	public function Validar($Email,$Password)
	{
		try 
		{
			...
			$login = $this->pdo->prepare("SELECT * FROM usuarios WHERE Email= :Email AND Password = :Password"); 
